...
import WaypointsDisplay from '../components/navigation/WaypointsDisplay';
import AircraftPositionDisplay from '../components/navigation/AircraftPositionDisplay';

const meta: Meta<typeof WaypointsDisplay> = {
  title: 'Navigation/WaypointsDisplay',
  component: WaypointsDisplay,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
export default meta;
type Story = StoryObj<typeof WaypointsDisplay>;
